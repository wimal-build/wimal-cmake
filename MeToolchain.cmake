...
function(me_install_toolchain)
    ...
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL Linux)
        if(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL x86_64)
            set(system x64-linux)
        elseif(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL aarch64)
            set(system a64-linux)
        endif()
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL Darwin)
        if(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL x86_64)
            set(system x64-macos)
        elseif(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL arm64)
            set(system a64-macos)
        endif()
    endif()
...
if(WIMAL_TARGET MATCHES "-macos" OR WIMAL_TARGET MATCHES "-ios" OR WIMAL_TARGET MATCHES "-sim")
    set(CMAKE_SYSTEM_NAME Darwin CACHE STRING CMAKE_SYSTEM_NAME)
else()
    set(CMAKE_SYSTEM_NAME Linux CACHE STRING CMAKE_SYSTEM_NAME)
endif()

if(WIMAL_TARGET MATCHES "^a64-")
    set(CMAKE_SYSTEM_PROCESSOR aarch64 CACHE STRING CMAKE_SYSTEM_PROCESSOR)
elseif(WIMAL_TARGET MATCHES "^arm-")
    set(CMAKE_SYSTEM_PROCESSOR arm CACHE STRING CMAKE_SYSTEM_PROCESSOR)
elseif(WIMAL_TARGET MATCHES "^x64-")
    set(CMAKE_SYSTEM_PROCESSOR x86_64 CACHE STRING CMAKE_SYSTEM_PROCESSOR)
elseif(WIMAL_TARGET MATCHES "^x86-")
    set(CMAKE_SYSTEM_PROCESSOR i386 CACHE STRING CMAKE_SYSTEM_PROCESSOR)
endif()
...
if(NOT WIMAL_TARGET MATCHES "-macos" AND NOT WIMAL_TARGET MATCHES "-ios" AND NOT WIMAL_TARGET MATCHES "-sim")
